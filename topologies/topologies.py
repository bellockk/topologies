...
# Define the topology class.  This makes the code contained within this module
# object oriented and allows its import into other functions to control data
# flow through multiple processors or networks.
...
class topology:
    ...
    def topologies(self, masterlist, allsubsets):
        """
        This algorith assembles a list of possible topologies on a given basis
        and tests each one to see if it satisfies the conditions for a
        topology.  It returns the topologies that are found.
        """
    ...
    def allsubsets(self,masterlist):
        """
        This function returns a list of all possible subsets that can be
        constructed from the masterlist.
        """
        subsets = [[]]
    ...
    def permutations(self,masterlist):
        ...
        repeats.  It also does this by a method faster than binary logic
        substitution.
        """
        permutations = []
        for item in masterlist:
